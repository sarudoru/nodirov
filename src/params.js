...
export const SCHEMA = [
  ...
  // ---- scroll input and final row alignment ----
  {
    key: "wheelMs",
    group: "Board",
    label: "wheel ease",
  ...
  // ---- ink ----
  { key: "paper", group: "Ink", label: "paper", type: "color", def: "#f7f6f0" },
  { key: "ink", group: "Ink", label: "ink", type: "color", def: "#292d29" },
  {
    key: "accent",
    group: "Ink",
    label: "accent",
...
export const FONTS = {
  // Optional comparison faces for the workbench. The main face is local Plex.
  ...
  plex: { family: "IBM Plex Mono", local: true, css: "IBM+Plex+Mono:wght@400" },
